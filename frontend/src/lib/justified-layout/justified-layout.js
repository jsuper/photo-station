require = (function e(t, n, r) {
  ...
  "justified-layout": [function (require, module, exports) {
    ...
    function computeLayout(itemLayoutData) {
      ...
      var bottomPadding = 0;
      if (typeof layoutConfig.containerPadding === "object") {
        bottomPadding = layoutConfig.containerPadding.bottom;
      } else if (typeof layoutConfig.containerPadding === "number") {
        bottomPadding = layoutConfig.containerPadding;
      }
      layoutData._containerHeight = layoutData._containerHeight + bottomPadding;
